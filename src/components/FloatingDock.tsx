...
export function FloatingDock() {
  ...
  return (
    <nav
      className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-[max(2.25rem,calc(0.85rem+env(safe-area-inset-bottom)))] pt-2"
      aria-label="Section shortcuts and theme"
    >
      <div className="pointer-events-auto relative flex max-w-[min(100%,32rem)] items-center gap-1 overflow-x-auto rounded-full border border-neutral-300/90 bg-white/95 px-2 py-1.5 shadow-[0_10px_30px_rgba(0,0,0,0.13),0_2px_8px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.85)] ring-1 ring-black/5 backdrop-blur-xl dark:border-neutral-700/80 dark:bg-neutral-950/92 dark:shadow-[0_14px_34px_rgba(0,0,0,0.62),0_2px_10px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.07)] dark:ring-white/10 sm:gap-1.5 sm:px-2.5 sm:py-2">
        <span
